...
电子邮件：dous1813@gmail.com， 电话：13095353020

屋里屋外开发者名称：三斗



屋里屋外深知个人信息对您的重要性，并会尽全力保护您的个人信息安全可靠。我致力于维持您对我们的信任，恪守以下原则，保护您的个人信息：权责一致原则、目的明确原则选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。同时，屋里屋外承诺，我们将按业界成熟的安全标准，采取适当的安全保护措施来保护您的个人信息。
...
您需要在守护宝APP中注册或登录守护宝帐号，通过守护宝帐号绑定守护宝智能硬件 来方便管理和控制守护宝智能硬件。当您注册守护宝账号时，守护宝会收集您的手机 号码、用户名、密码，收集这些信息是为了帮助您完成守护宝账号注册，保护您的账号 安全。如果您拒绝提供这些信息，您可能无法正常注册守护宝账号， 也无法享受我们提供的基于账号的个性化服务。您也可以通过“守护宝->我的->个人信息”界面修改用户名、头像。

2、间接收集的信息

为方便您登录守护宝账号，您可以通过微信、QQ、微博第三方账号登陆本款产品及守护宝的其他产品和服务。为实现前述目的，我们可能需要从第三方获取并收集您的第三方账号信息，如昵称、头像。除上述情况外，目前守护宝不会主动从第三方获取您的个人信息，如果未来业务发展需要从第三方间接获取您的个人信息，我们会在获取前向您明示个人信息的来源、类型及使用范围。如果守护宝开展业务需要进行的个人信息处理活动超出了您向第三方授权同意的处理范围，我们将在处理您的个人信息前征得您的明示同意。 我们也将严格遵守相关法律规定，要求第三方保障其提供的信息的合法性。

3、智能设备绑定功能

守护宝APP需要与守护宝智能硬件进行绑定，以实现通过手机管理守护宝智能硬件设备。在设置绑定的过程中，需要您提供已注册的守护宝终端帐号和密码，此信息为实现通过手机管理守护宝智能硬件所必须提供的信息。部分守护宝智能硬件设备可通过扫二维码形式绑定，通过扫二维码绑定设备时会提示是否允许我们使用相机权限， 拒绝使用将无法通过扫描二维码形式快速绑定守护宝智能设备。

4、收集关爱终端所产生的信息

为了方便您通过守护宝来管理您的守护宝智能硬件，我们会通过数据、WiFi连接您的守护宝智能硬件，并获得您的智能硬件所产生的相关内容信息。获取的信息有：守护宝智能硬件位置、通讯录、相册、SOS号码、闹钟、情景模式、 步数、应用使用时长、当前使用应用、应用使用时间。

5、第三方分享

在守护宝APP中，您可以将各种活动信息通过第三方平台分享给您的朋友。在您分享的过程中，第三方平台会要求您进行登录或注册，您需要手动输入您在第三方产品的用户名和密码进行注册或登录。守护宝APP不会保存也不会监控第三方产品的用户名和密码，同时，也不会将您的手机号或您在守护宝设备中使用的用户名和密码发送给第三方。

（二）基于位置的个性化服务

当您完成守护宝APP安装后，您可以通过弹窗选择是否允许我们收集您的GPS位置信息。如果您同意我们收集您的GPS位置信息，您可以使用守护宝APP快速导航至绑定终端位置。 拒绝提供位置信息仅会使您无法享受基于前述基于位置的服务，而不会影响您正常使用本款产品的其他功能。

（三）安全保障

为提高您使用我们及我们关联公司、合作伙伴提供服务的安全性，保护您或其他用户或公众的人身财产安全免遭侵害，更好地预防钓鱼网站、欺诈、网络漏洞、计算机病毒、网络攻击、网络侵入等安全风险，更准确地识别违反法律法规或守护宝相关协议规则的情况。我们可能使用或整合您的账户信息、设备信息、软件使用信息以及我们关联公司、 合作伙伴取得您授权或依据法律共享的信息，用于进行身份验证、检测及防范安全事件，并依法采取必要的记录、审计、分析、处置措施。

（四）征得授权同意的例外

当我们要将信息用于本政策未载明的其它用途时，会事先征求您的同意。当我们要将基于特定目的收集而来的信息用于其他目的时， 会事先征求您的同意。如您需撤回同意权限，可通过手机设置-守护宝应用内关闭相应权限。
...
为使您获得更轻松的访问体验，您使用守护宝的产品或服务时，我们可能会通过采用各种技术收集和存储您访问守护宝服务的相关数据，在您访问或再次访问守护宝服务时，我们能识别您的身份，并通过分析数据为您提供更好更多的服务。包括使用小型数据文件识别您的身份，以便了解您的使用习惯，帮您省去重复输入账户信息的步骤，或者帮助判断您的账户安全。 这些文件可能是Cookie\Flash Cookie,或您的浏览器或关联应用程序提供的其他本地存储（统称“Cookie")。
...
我们不会与南京守护宝信息技术有限公司以外的任何公司、组织和个人分享您的个人信息，但以下情况除外：

1、在获取明确同意的情况下共享：获得您的明确同意后，我们会与其他方共享您的个人信息。

2、我们可能会根据法律法规规定，或按政府主管部门的强制性要求，对外共享您的个人信息。

3、与我们的附属公司共享：您的个人信息可能会与南京守护宝的附属公司共享。我们只会共享必要的个人信息，且受本隐私政策中所声明目的的约束。 附属公司如要改变个人信息的处理目的，将再次征求您的授权同意。
...
如果您无法通过上述链接/方式访问这些个人信息，您可以发送电子邮件至zteshouhubao@163.com。我们将在15天内回复您的访问请求。对于您在使用我们的产品或服务过程中产生的其他个人信息，只要我们不需要过多投入，我们会向您提供。

（二） 更正您的个人信息
当您发现我们处理的关于您的个人信息有错误时，您有权要求我们做出更正。您可以通过“（一）访问您的个人信息”中罗列的方式提出更正申请。如果您无法通过上述链接更正这些个人信息， 您可以随时发送电子邮件至zteshouhubao@163.com, 我们将在15天内回复您的更正请求。
...
2、您可以随时发送电子邮件至zteshouhubao@163.com, 我们将在15天内回复您； 在注销账户之后，我们将停止为您提供产品或服务，并依据您的要求，删除您的个人信息，法律法规另有规定
...
七、 您的个人信息如何在全球范围转移
守护宝服务仅面向中华人民共和国境内用户，我们在中华人民共和国境内收集和产生的个人信息，将存储在中华人民共和国境内。
